...
# TJM Frostbite | Dev-Log 44 |  @TJM Dev-Logs
...
# TJM Frostbite | Dev-Log 43 |  @TJM Dev-Logs
...
# TJM Frostbite | Dev-Log 42 |  @TJM Dev-Logs 
...
# TJM Frostbite | Dev-Log 41 |  @TJM Dev-Logs 
...
# TJM Frostbite | Dev-Log 40 |  @TJM Dev-Logs 
...
# TJM Frostbite | Dev-Log 39 |  @TJM Dev-Logs 
...
# TJM Frostbite | Dev-Log 38 |  @TJM Dev-Logs 
- Temperature changes:
...
# TJM Frostbite | Dev-Log 37 |  @TJM Dev-Logs 
- Temperature changes:
...
# TJM Frostbite | Dev-Log 36 |  @TJM Dev-Logs 
...
# TJM Frostbite | Dev-Log 35 |  @TJM Dev-Logs 
...
# TJM Frostbite | Dev-Log 34 |  @TJM Dev-Logs 
- Updated Fishing.
  - Fixed Swordfish.
  - Fixed Fishaxe.
...
# TJM Frostbite | Dev-Log 33 |  @TJM Dev-Logs 
- Updated Fishing.
...
# TJM Frostbite | Dev-Log 32 |  @TJM Dev-Logs 
...
# TJM Frostbite | Dev-Log 31 |  @TJM Dev-Logs 
...
# TJM Frostbite | Dev-Log 30 |  @TJM Dev-Logs 
...
# TJM Frostbite | Dev-Log 29 | @TJM Dev-Logs 
...
# TJM Frostbite | Dev-Log 28 | @TJM News 
...
# TJM Frostbite | Dev-Log 26 | @TJM News 
...
> More Content is Coming Soon!!! :g_JM_art_big_love:
# TJM Frostbite | Dev-log 25
...
> 
> If anyone has any ideas for his crafting recipe please let me know! :D

# TJM Frostbite | Dev-log 19
...
# TJM Frostbite | Dev-log 17
> Today I patched some bugs and made the new underwater cave
> from https://discord.com/channels/845026337797963836/1178112418052849675/1209674825845710928have Deepslate and tuff walls because it is under 0, yeah it
> works like that in TJM, I also remade the tags for the <#1202740601574137866> channel so
> users have more choices and it just looks better! :D

# TJM Frostbite | Dev-log 16
...
> some shops will even have Owners with their own voice lines, but I'm not saying who! :eyes:

# TJM Frostbite | Dev-log 13
> Nothing much, nothing much...
> You know I just added a whole new type of sword which can have "bleeding" on it, that is
> very editable, I can make it very deadly, or not deadly (developed by @axathearcticfox , Idea from @ohm_000)
> 
> I've currently just been fixing a couple bugs and making the server look more better thanks to
> custom models :)

# TJM Frostbite | Dev-log 12
...
> Got any cool idea for TJM? please drop them in <#1202740601574137866>!

# TJM Frostbite | Dev-log 11
...
> added custom fishing loot which includes a very rare weapon which @bloxland 
> thought of :)
